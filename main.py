...
with st.sidebar:
    ...
    profiler = st.selectbox("Select Profiler Type", options=["KIC", "SEFRAM"])
    test = st.selectbox("Select Test Type", options=["Thermal Cycle (TC)", "Humidity Freeze (HF)", "Damp Heat (DH)", "Thermal Shock (TS)"])
